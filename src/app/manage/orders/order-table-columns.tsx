...
import { formatCurrency, formatDateTimeToLocaleString, getVietnameseOrderStatus, simpleMatchText } from '@/utils'
        ...
        <Popover>
          <PopoverTrigger asChild>
            <Image
              ...
              width={50}
              height={50}
              className="size-[50px] cursor-pointer rounded-md object-cover"
            />
          </PopoverTrigger>
          <PopoverContent>
